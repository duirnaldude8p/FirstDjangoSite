...
$(function(){
    ...
    $.ajax({
        ...
        success: function(value){
            ...
            $title.text(value.bussiness.title);
            $image.attr("src", value.bussiness.picture);
            $text.text(value.bussiness.text);
            var ncomments = value.bussiness.bizComments;
            ...
            currlod = value.currentAccount.bizPagelikeOrDislike;
